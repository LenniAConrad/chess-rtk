...
public final class Support {
     ...
     *
     * <p>
     * Example: {@code CRTK_ONEAPI_LIB=/absolute/path/to/liblc0j_oneapi.so}
     * </p>
     */
    ...
    private static final SharedLibrarySupport.State STATE =
            SharedLibrarySupport.load(LIB_BASE_NAME, ENV_ONEAPI_LIB, DIR_NATIVE_ONEAPI, Support::nativeDeviceCount);
