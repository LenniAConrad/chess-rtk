 ...
 *
 * <p>This uses a native shared library ({@code lc0_rocm}) and will only be used when:
 * <ul>
...
public final class Backend implements AutoCloseable {
    ...
    /**
     * Creates a ROCm evaluator from a ChessRTK LC0 CNN {@code .bin} weights file.
     *
    ...
    /**
     * JNI entry point implemented in {@code native/rocm/lc0_cnn_rocm_jni.hip}.
     *
