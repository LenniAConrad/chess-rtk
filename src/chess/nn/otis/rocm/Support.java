...
/**
 * Optional ROCm (AMD) support for OTIS native inference via a tiny JNI shared
 * library (no third-party Java deps).
 *
 * <p>This class loads the JNI library ({@code libotis_rocm.so}/{@code otis_rocm.dll})
 ...
 * {@code -Djava.library.path=/path/to/build/dir} or set {@code CRTK_OTIS_ROCM_LIB}.
 *
...
public final class Support {
     ...
     */
    private static final String LIB_BASE_NAME = "otis_rocm";

    /**
     * Environment variable that can point to an explicit ROCm JNI library path.
     *
     * <p>
     * Example: {@code CRTK_OTIS_ROCM_LIB=/absolute/path/to/libotis_rocm.so}
     * </p>
     */
    private static final String ENV_OTIS_ROCM_LIB = "CRTK_OTIS_ROCM_LIB";
    ...
    private static final SharedLibrarySupport.State STATE =
            SharedLibrarySupport.load(LIB_BASE_NAME, ENV_OTIS_ROCM_LIB, DIR_NATIVE_ROCM, Support::nativeDeviceCount);
