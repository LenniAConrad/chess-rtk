...
/**
 * Optional oneAPI (Intel) support for OTIS native inference via a tiny JNI shared
 * library (no third-party Java deps).
 *
 * <p>This class loads the JNI library ({@code libotis_oneapi.so}/{@code otis_oneapi.dll})
 ...
 * {@code -Djava.library.path=/path/to/build/dir} or set {@code CRTK_OTIS_ONEAPI_LIB}.
 *
...
public final class Support {
     ...
     */
    private static final String LIB_BASE_NAME = "otis_oneapi";

    /**
     * Environment variable that can point to an explicit oneAPI JNI library path.
     *
     * <p>
     * Example: {@code CRTK_OTIS_ONEAPI_LIB=/absolute/path/to/libotis_oneapi.so}
     * </p>
     */
    private static final String ENV_OTIS_ONEAPI_LIB = "CRTK_OTIS_ONEAPI_LIB";
    ...
    private static final SharedLibrarySupport.State STATE =
            SharedLibrarySupport.load(LIB_BASE_NAME, ENV_OTIS_ONEAPI_LIB, DIR_NATIVE_ONEAPI, Support::nativeDeviceCount);
