...
/**
 * JNI-backed oneAPI kernels for T5 inference.
 *
 * @since 2026
...
public final class Kernels {
  ...
  /**
   * Runs a oneAPI matmul where {@code bT} is already transposed.
   *
   * @param a left matrix [m, k]
   * @param bT right matrix transposed [n, k]
   * @return output tensor [m, n], or {@code null} when oneAPI is unavailable
   */
