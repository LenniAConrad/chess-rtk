...
/**
 * Optional ROCm backend for end-to-end T5 inference.
 *
 * <p>This loads the native {@code t5_rocm} library and runs greedy decoding on the GPU.
...
public final class Backend implements AutoCloseable {
  ...
  /**
   * Native handle to the ROCm model instance.
   */
  ...
  /**
   * Attempts to create a ROCm backend for the given model.
   *
  ...
  /**
   * JNI entry point implemented in {@code native/rocm/t5_rocm_jni.hip}.
   *
