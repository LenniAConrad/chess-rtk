...
/**
 * Optional CUDA backend (JNI) for split-depth bulk perft.
 *
 * <p>
...
public final class Backend {
    ...
    /**
     * @return {@code true} when the CUDA perft backend is loaded and a device is present
     */
     ...
     * @param count number of frontier positions
     * @param remainingDepth non-negative depth below each frontier position
     * @return {@code count * 7} counters (nodes, captures, ep, castles,
     *         promotions, checks, checkmates per position), or {@code null} on failure
     */
