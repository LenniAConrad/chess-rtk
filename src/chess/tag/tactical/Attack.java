 ...
 * attackers and forks, matching the textual style used in {@link chess.tag.piece.PieceAblationTagger}. Each output
...
public final class Attack {
    ...
    /**
     * Returns true when the attack is likely tactically meaningful.
     *
     * <p>
     * We keep checks, attacks on undefended pieces, and attacks on higher-value targets.
     * </p>
     *
     * @param board board array
     ...
     * @return true if the attack should be emitted
     */
    ...
    /**
     * Returns true if {@code targetSquare} is defended by any piece of the target side.
     *
     * @param board board array
     * @param targetSquare square to check
     * @param targetIsWhite side that owns the target piece
     * @param ignoreSquare square to ignore (typically the attacker square)
    ...
    private static boolean isDefended(byte[] board, byte targetSquare, boolean targetIsWhite, byte ignoreSquare) {
        for (int index = 0; index < board.length; index++) {
            ...
            if (index == targetSquare || index == ignoreSquare) {
                continue;
            }
