 ...
 * @param stopped            true when a node or time budget interrupted the
 *                           final iteration
...
public record Result(
    ...
    /**
     * Compares this search result with another result.
     *
    ...
    /**
     * Computes a hash over the search summary and principal variation.
     *
    ...
    /**
     * Formats this result for diagnostics.
     *
     * @return debug string containing search summary fields
     */
    @Override
