...
/**
 * Serializes Art of Chess manifests to TOML.
 *
 * @since 2026
...
public final class TomlWriter {
	...
	/**
	 * Serializes one Art of Chess manifest to TOML.
	 *
	 * @param book source manifest
	 * @return TOML text
	 */
	public static String toToml(ArtBook book) {
		if (book == null) {
		...
		appendString(sb, "pageSize", ArtBook.pageSizeToken(book.getPageSize()));
