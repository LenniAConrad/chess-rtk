...
/**
 * Builds I Love Chess-style book manifests from analyzed puzzle records.
 *
 * <p>
...
public final class Builder {
	...
	/**
	 * Builds one I Love Chess-style book model from puzzle records.
	 *
	 ...
	 */
	private static String formatSanLine(Position start, short[] pv) {
	...
	/**
	 * Returns explicit introduction paragraphs or I Love Chess-style defaults.
	 *
	...
	private static String[] defaultIntroduction(String[] introduction, int count, String title, String subtitle) {
		...
		String fullTitle = subtitle == null || subtitle.isBlank() ? blankTo(title, "I Love Chess")
				: blankTo(title, "I Love Chess") + ": " + subtitle;
		return new String[] {
				...
				"This volume contains " + countText
						+ " curated positions laid out in the I Love Chess format: puzzle diagrams on the left, resolved positions on the right, and recurring lookup tables for fast review.",
