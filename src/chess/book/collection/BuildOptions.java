...
/**
 * Mutable options used when building a puzzle-collection book manifest from
 * puzzle records.
 *
 * @since 2026
...
public final class BuildOptions {
	 ...
	 */
	private String title = "Chess Puzzle Collection";
	...
	public BuildOptions setTitle(String title) {
		this.title = blankTo(title, "Chess Puzzle Collection");
		return this;
	}
