 ...
 */
public final class BookRenderCommand {
	 ...
	 */
	public static void runBookRender(Argv a) {
		...
		try {
			...
			Writer.write(resolvedOutput, book, watermark.enabled(), watermark.id());
