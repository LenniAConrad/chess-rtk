...
/**
 * Stateless atlas geometry and heatmap helpers for {@link WorkbenchNnueView}.
 */
final class WorkbenchNnueAtlas {

    /**
     * Utility class.
     */
    private WorkbenchNnueAtlas() {
    }
     ...
     */
    static int pickAtlasRowHeight(int hidden) {
        if (hidden >= 512) {
            return 24;
        }
        if (hidden >= 256) {
     ...
     * @return tile width
     */
    static int pickAtlasTileWidth(int hidden) {
     ...
     */
    static int parseSlotNumber(String title) {
     ...
     */
    static int parseFirstInteger(String title, int start) {
        int end = start;
     ...
     */
    static int parseFeatureIndex(String title) {
     ...
     * @return strip height
     */
    static int atlasWholeOverviewHeight(int contentHeight) {
     ...
     */
    static float[] computePerNeuronScale(float[] data, int hidden, int planes, int squares) {
     ...
     */
    static void overlaySelectedSquare(Graphics2D g, Rectangle tile, int square) {
     ...
     * @return short label
     */
    static String atlasPlaneLabel(int plane, int totalPlanes) {
        char[] own = { 'P', 'N', 'B', 'R', 'Q' };
     ...
     * @return long name
     */
    static String atlasPlaneName(int plane, int totalPlanes) {
     ...
     */
    static void paintAtlasTileDense(Graphics2D g, Rectangle r, float[] atlas,
     ...
     * @return colour
     */
    static java.awt.Color atlasRamp(float v) {
