...
abstract class WorkbenchNnueViewBase extends WorkbenchNetworkView implements Scrollable {
     ...
     */
    protected WorkbenchActivationSnapshot atlasCompare;
     ...
     */
    protected List<WorkbenchNetworkPanel.NnueAtlasEntry> atlasGridEntries = new ArrayList<>();
     ...
     * @return trace layout
     */
    protected abstract WorkbenchNnueTraceLayout layout(Rectangle r);
