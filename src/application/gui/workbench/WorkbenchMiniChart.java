 ...
 */
final class WorkbenchMiniChart extends JComponent {
     ...
     */
    private static final int INSET = WorkbenchTheme.SPACE_XS;
    ...
    WorkbenchMiniChart() {
        setOpaque(false);
        setForeground(WorkbenchTheme.ACCENT);
    }
     ...
     */
    void setBars(float[] heights, Color[] colors) {
        this.mode = Mode.BARS;
    ...
    protected void paintComponent(Graphics graphics) {
        ...
        try {
            ...
            g.fillRoundRect(0, 0, w - 1, h - 1, WorkbenchTheme.RADIUS, WorkbenchTheme.RADIUS);
            g.setColor(WorkbenchTheme.LINE);
            g.drawRoundRect(0, 0, w - 1, h - 1, WorkbenchTheme.RADIUS, WorkbenchTheme.RADIUS);
    ...
    private void paintEmpty(Graphics2D g, int w, int h) {
        ...
        g.setFont(WorkbenchTheme.font(10, java.awt.Font.PLAIN));
    ...
    private void paintLine(Graphics2D g, int x, int y, int plotW, int plotH) {
        ...
        if (n >= 2) {
            ...
            g.setColor(WorkbenchTheme.withAlpha(getForeground(), 38));
            g.fillPolygon(fill);
