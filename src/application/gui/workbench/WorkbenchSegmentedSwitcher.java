 ...
 * inside a dropdown.</p>
 */
final class WorkbenchSegmentedSwitcher extends JComponent {
     ...
     */
    WorkbenchSegmentedSwitcher(String[] labels) {
     ...
     */
    void setSegmentEnabled(int index, boolean value) {
    ...
    public Dimension getPreferredSize() {
        FontMetrics fm = getFontMetrics(WorkbenchTheme.font(13, Font.BOLD));
        int total = 0;
    ...
    private void paintSegment(Graphics2D g, Rectangle r, int index, FontMetrics fm) {
        ...
        int arcRight = index == labels.length - 1 ? WorkbenchTheme.RADIUS : 0;
