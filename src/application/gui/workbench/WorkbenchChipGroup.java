 ...
 */
final class WorkbenchChipGroup extends JComponent {
     ...
     */
    WorkbenchChipGroup(List<String> labels) {
     ...
     */
    void setOnSelect(IntConsumer listener) {
    ...
    private void layoutChips() {
        FontMetrics fm = getFontMetrics(WorkbenchTheme.font(12, Font.BOLD));
        int x = 0;
