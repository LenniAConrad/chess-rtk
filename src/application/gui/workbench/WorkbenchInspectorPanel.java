 ...
 */
final class WorkbenchInspectorPanel extends JPanel {
     ...
     */
    private final JButton clearButton = WorkbenchUi.button("Clear", false, null);
     ...
     */
    private static String educationalText(WorkbenchHitRegions.Region region) {
     ...
     */
    private static String composeClipboard(WorkbenchHitRegions.Region region, String stats, String body) {
        StringBuilder sb = new StringBuilder();
