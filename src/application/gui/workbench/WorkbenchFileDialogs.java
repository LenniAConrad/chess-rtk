 ...
 */
final class WorkbenchFileDialogs {

    /**
     * Prevents instantiation.
     */
    private WorkbenchFileDialogs() {
        // utility
    }
     ...
     */
    static void choosePath(Component owner, JTextField target, boolean save, String title) {
     ...
     */
    static JFileChooser createFileChooser(String title, File selectedFile, FileNameExtensionFilter filter) {
        ...
        WorkbenchUi.styleFileChooser(chooser);
        return chooser;
    }
