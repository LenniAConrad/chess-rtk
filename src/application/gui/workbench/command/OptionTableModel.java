 ...
 */
public final class OptionTableModel extends AbstractTableModel {
     ...
     */
    public void setOptions(List<CommandOption> options, TemplateContext context) {
        rows.clear();
     ...
     */
    public List<String> enabledArgs() {
    ...
    private static String displayFlag(CommandOption option) {
        ...
        if (option.fixedChoice()) {
            return CommandLabels.choiceLabel(defaultValue);
        }
