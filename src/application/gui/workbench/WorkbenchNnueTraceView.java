...
abstract class WorkbenchNnueTraceView extends WorkbenchNnueOverviewView {
     ...
     * @param layout layout
     */
    protected void drawTraceBackdrop(Graphics2D g, Rectangle wire, WorkbenchNnueTraceLayout layout) {
        int top = wire.y + 4;
     ...
     */
    protected void drawClassicTrunkRails(Graphics2D g, WorkbenchNnueTraceLayout layout) {
     ...
     * @param layout layout
     */
    protected void drawColumnLabels(Graphics2D g, WorkbenchNnueTraceLayout layout) {
        int y = layout.labelY;
     ...
     * @param layout layout
     */
    protected void drawFeatureColumn(Graphics2D g, WorkbenchNnueTraceLayout layout) {
     ...
     * @param layout layout
     */
    protected void drawAccumulatorColumn(Graphics2D g, WorkbenchNnueTraceLayout layout) {
        if (isStockfishSnapshot()) {
     ...
     * @param layout layout
     */
    protected void drawClippedColumn(Graphics2D g, WorkbenchNnueTraceLayout layout) {
        if (isStockfishSnapshot()) {
     ...
     * @param layout layout
     */
    protected void drawContributionColumn(Graphics2D g, WorkbenchNnueTraceLayout layout) {
        if (isStockfishSnapshot()) {
     ...
     * @param layout layout
     */
    protected void drawStockfishTransformerColumn(Graphics2D g, WorkbenchNnueTraceLayout layout) {
        float[] transformed = snapshot.data("nnue.stockfish.transformed.us");
        if (transformed == null) {
            return;
        }
     ...
     * @param layout layout
     */
    protected void drawStockfishFc0Column(Graphics2D g, WorkbenchNnueTraceLayout layout) {
        float[] fc0 = snapshot.data("nnue.stockfish.fc0.raw");
     ...
     * @param layout layout
     */
    protected void drawStockfishFc1Column(Graphics2D g, WorkbenchNnueTraceLayout layout) {
        float[] fc1 = snapshot.data("nnue.stockfish.fc1.clipped");
        if (fc1 == null) {
            return;
        }
     ...
     * @param layout layout
     */
    protected void drawOutputColumn(Graphics2D g, WorkbenchNnueTraceLayout layout) {
     ...
     * @param layout trace layout
     */
    protected void drawSlotZoom(Graphics2D g, Rectangle r, WorkbenchNnueTraceLayout layout) {
     ...
     * @param layout layout
     */
    protected void drawEdges(Graphics2D g, WorkbenchNnueTraceLayout layout) {
        if (isStockfishSnapshot()) {
     ...
     * @param layout layout
     */
    protected void drawStockfishEdges(Graphics2D g, WorkbenchNnueTraceLayout layout) {
        float[] featureWeights = snapshot.data("nnue.features.us.weights");
        int[] featureWeightShape = snapshot.shape("nnue.features.us.weights");
     ...
     * @param layout layout
     */
    protected void drawDetailedReadout(Graphics2D g, Rectangle body, WorkbenchNnueTraceLayout layout) {
        if (selectedSlot < 0 || selectedSlot >= visibleSlots.length) {
            g.setColor(WorkbenchTheme.MUTED);
            g.setFont(WorkbenchTheme.font(11, Font.PLAIN));
