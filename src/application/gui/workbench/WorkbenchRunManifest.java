 ...
 */
final class WorkbenchRunManifest {

    /**
     * Manifest schema identifier.
     */
    static final String SCHEMA = "crtk.workbench.run-manifest.v1";

    /**
     * Directory for persisted workbench run manifests.
     */
    static final Path DEFAULT_DIR = Path.of("session", "workbench-runs");
     ...
     */
    static Path write(WorkbenchJob job, List<Path> artifacts, String stdin,
     ...
     * @throws IOException when writing fails
     */
    static Path write(Path directory, WorkbenchJob job, List<Path> artifacts, String stdin,
            Path workingDirectory) throws IOException {
        if (job == null) {
     ...
     * @return filename
     */
    private static String fileName(WorkbenchJob job) {
     ...
     * @return JSON text
     */
    private static String toJson(WorkbenchJob job, List<Path> artifacts, String stdin,
