 ...
 * actual drawing of each {@link WorkbenchViewMode}.</p>
 *
 * <p>State that crosses the inference boundary ({@link #snapshot}) is only ever
 * a {@linkplain WorkbenchActivationSnapshot#isSealed() sealed} snapshot, so the
 * EDT can paint it while a background worker builds the next one without any
 * shared mutable state.</p>
 */
abstract class WorkbenchNetworkView extends JComponent {
     ...
     */
    protected WorkbenchActivationSnapshot snapshot;
     ...
     */
    private WorkbenchViewMode mode = WorkbenchViewMode.ABSTRACT;
     ...
     */
    protected WorkbenchInspectorPanel inspector;

    /**
     * Hover + click region registry, rebuilt every paint pass.
     */
    protected final WorkbenchHitRegions hitRegions = new WorkbenchHitRegions();
     ...
     */
    protected WorkbenchNetworkView(int preferredWidth, int preferredHeight) {
        setOpaque(true);
     ...
     */
    final void setInspector(WorkbenchInspectorPanel panel) {
     ...
     */
    final void setSnapshot(WorkbenchActivationSnapshot newSnapshot) {
     ...
     */
    final void setFen(String newFen) {
        this.fen = newFen;
        repaint();
    }
     ...
     */
    final void setFixedScale(boolean value) {
     ...
     */
    final void setViewMode(WorkbenchViewMode newMode) {
     ...
     * @return current mode
     */
    protected final WorkbenchViewMode viewMode() {
        return mode;
    }
    ...
    protected final boolean isAbstract() {
        return mode == WorkbenchViewMode.ABSTRACT;
    }
    ...
    protected final boolean isDetailed() {
        return mode == WorkbenchViewMode.DETAILED;
    }
    ...
    protected final boolean isRaw() {
        return mode == WorkbenchViewMode.RAW;
    }
    ...
    protected final boolean isAtlas() {
        return mode == WorkbenchViewMode.ATLAS;
    }
    ...
    protected final boolean isDiagram() {
        return mode == WorkbenchViewMode.DIAGRAM;
    }
