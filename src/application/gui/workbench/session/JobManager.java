...
/**
 * Bounded history of {@link Job} command runs for the workbench
 * dashboard.
 *
...
public final class JobManager {
     ...
     */
    public Job create(List<String> args) {
        Job job = new Job(nextId++, args,
     ...
     */
    public void markFinished(Job job, int exitCode, String output, long durationMillis) {
