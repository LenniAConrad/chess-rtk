 ...
 * {@link JobManager}'s history, for the dashboard's recent-jobs table.
 *
...
public final class JobTableModel extends AbstractTableModel {
     ...
     */
    public static final int COL_COMMAND = 0;
     ...
     */
    public JobTableModel(JobManager manager) {
