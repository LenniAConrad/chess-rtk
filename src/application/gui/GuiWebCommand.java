...
import application.gui.web.WebGuiWindow;
import utility.Argv;

/**
 * Implements the {@code gui-web} CLI command.
 *
 * @since 2026
 */
public final class GuiWebCommand {

	/**
	 * Utility class; prevent instantiation.
	 */
	private GuiWebCommand() {
		// utility
	}

	/**
	 * Launches the chess-web-inspired Swing GUI.
	 *
	 * @param a parsed CLI arguments
	 */
	public static void runGuiWeb(Argv a) {
		...
		String initialFen = (fen == null || fen.isBlank()) ? WebGuiWindow.DEFAULT_FEN : fen;
